    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-brand-200">
      ...
      <main className="pb-20">
        ...
        <section className="pt-20 pb-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
          ...
          <div className="bg-brand-100 border-l-4 border-brand-600 p-4 max-w-2xl mx-auto text-left rounded-r-lg shadow-sm">
          ...
          <dl className="space-y-8">
            {dict.terms.map((item: any) => (
              ...
              >
                ...
                <dd className="text-slate-600 leading-relaxed mt-2">{item.definition}</dd>
              </div>
            ))}
          </dl>
        </section>
